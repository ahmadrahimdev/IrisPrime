 ...
 * This file demonstrates how to integrate Irisprime with a web frontend
 */

// For React/Vue/Angular applications
export class IrisprimeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new IrisprimeClient(provider, contractAddress);
